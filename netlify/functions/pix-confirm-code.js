 ...
 * anterior está no histórico do git (pix-confirm-code.js, commit anterior a esta data).
 *
 ...
 *
 * Antes: enviava e validava o código de confirmação de chave PIX (CPF, e-mail ou telefone — dado pessoal sob a LGPD).
 *
...
export async function handler(event) {
  ...
  console.warn('[pix-confirm-code.js] chamada a endpoint desativado de', 
