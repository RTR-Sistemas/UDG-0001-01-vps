 ...
 * anterior está no histórico do git (payment-webhook.js, commit anterior a esta data).
 *
 ...
 *
 * Antes: recebia webhook do Mercado Pago e confirmava pedidos com a service_role. Era o ponto de maior risco financeiro do sistema.
 *
...
export async function handler(event) {
  ...
  console.warn('[payment-webhook.js] chamada a endpoint desativado de', 
