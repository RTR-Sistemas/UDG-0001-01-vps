 ...
 * anterior está no histórico do git (purchase-coins.js, commit anterior a esta data).
 *
 ...
 *
 * Antes: criava pedido de compra de moedas e creditava saldo.
 *
...
export async function handler(event) {
  ...
  console.warn('[purchase-coins.js] chamada a endpoint desativado de', 
