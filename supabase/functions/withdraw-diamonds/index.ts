/**
 * =============================================================================
 * Edge Function: withdraw-diamonds
 *
 * DESATIVADA em 30/08/2026 — o UndoinG não usa pagamento por enquanto.
 *
 * Antes: processava a solicitação de saque de diamantes.
 *
 ...
 *     Para remover de vez:
 *         supabase functions delete withdraw-diamonds --project-ref ipmldkprqdhybedhpgmt
...
Deno.serve((req: Request) => {
  const origem = req.headers.get("cf-connecting-ip") ??
                 ...
                 "origem desconhecida";
  console.warn(`[withdraw-diamonds] chamada a função desativada de ${origem}`);
