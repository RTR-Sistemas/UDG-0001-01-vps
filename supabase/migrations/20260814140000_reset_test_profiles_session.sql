/* ===========================================================================
   ...
   Este arquivo reseta a sessao dos perfis de teste.
   ...
   O conteudo original foi preservado em: supabase/seed_dev/20260814140000_reset_test_profiles_session.sql
   Este arquivo continua existindo para nao quebrar o historico de migracoes
   ja aplicadas no banco, mas nao executa mais nada.
   =========================================================================== */

do $$ begin
  raise notice '20260814140000_reset_test_profiles_session.sql: semente de teste neutralizada (ver supabase/seed_dev/).';
end $$;
