/* ===========================================================================
   ...
   Este arquivo cria o caminho de pagamento FICTICIO.
   ...
   O conteudo original foi preservado em: supabase/seed_dev/20260814110000_mock_payments.sql
   Este arquivo continua existindo para nao quebrar o historico de migracoes
   ja aplicadas no banco, mas nao executa mais nada.
   =========================================================================== */

do $$ begin
  raise notice '20260814110000_mock_payments.sql: semente de teste neutralizada (ver supabase/seed_dev/).';
end $$;
